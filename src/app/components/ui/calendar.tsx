    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_range_start: "day-range-start aria-selected:bg-blue-600 aria-selected:text-blue-600-foreground",
                day_range_end: "day-range-end aria-selected:bg-blue-600 aria-selected:text-blue-600-foreground",
                day_selected: "bg-blue-600 text-white hover:bg-blue-600 hover:text-blue-600-foreground focus:bg-blue-600 focus:text-blue-600-foreground",
